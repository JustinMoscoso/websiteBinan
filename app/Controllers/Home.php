...
class Home extends BaseController
{
        ...
        */
        ...
        <div style='font-family: Arial, sans-serif; line-height: 1.6;'>
            ...
            <p style='color:#666; font-size:13px;'>
                This email was automatically generated by the Biñan Website Contact System.
            </p>
    ...
    ");
        ...
        */
        ...
        // PROFESSIONAL SUBJECT
        $email->setSubject(
            'We Received Your Inquiry - Biñan Tech Support'
        );
        ...
        <div style='font-family: Arial, sans-serif; line-height: 1.6;'>
            ...
            <p>
                Thank you for contacting <strong>Biñan Tech Support</strong>.
            </p>
            ...
            <p>
                Please do not reply to this automated email unless additional information is needed.
            </p>
            ...
            <p>
                <strong>Biñan Tech Support Team</strong><br>
                Website Support Services
            </p>
           <img src='" . base_url('assets/img/binanlogo.png') . "' 
     alt='Biñan Tech Support' 
     style='width:150px; margin-top:10px;'>

            <hr>

            <p style='font-size:12px; color:#777;'>
                This is an automated confirmation email from the Biñan Website Contact System.
            </p>
    ...
    ");
        ...
        if (!$email->send()) {
            ...
            return $this->response->setJSON([
                'status' => 'error',
                'message' => 'Admin received the message but confirmation email failed.'
            ]);
        }
