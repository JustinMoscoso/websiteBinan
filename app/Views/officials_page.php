...
<head>
    ...
    <style>
        .official-modal .modal-body {
            display: flex;
            gap: 20px;
        }

        .official-modal .modal-body img {
            max-width: 200px;
            height: auto;
        }
        ...
        <div class="row">
            ...
            <?php if ($officialsByType['congress']) : ?>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 mt-4">
                        <div class="cookie-card view-official-btn" data-bs-toggle="modal"
                             data-bs-target="#officialModal" data-id="<?= $officialsByType['congress']->ID ?>"
                             data-position="<?= $officialsByType['congress']->off_position ?>">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="pic">
                                        <img src="<?= base_url('admin/image/CITYOFFICIAL/' . $officialsByType['congress']->img_loc) ?>"
                                             class="img-fluid" alt="">
                                    </div>
                                </div>
            ...
            <?php if ($officialsByType['cityMayor']) : ?>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 mt-4">
                        <div class="cookie-card view-official-btn" data-bs-toggle="modal"
                             data-bs-target="#officialModal" data-id="<?= $officialsByType['cityMayor']->ID ?>"
                             data-position="<?= $officialsByType['cityMayor']->off_position ?>">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="pic">
                                        <img src="<?= base_url('admin/image/CITYOFFICIAL/' . $officialsByType['cityMayor']->img_loc) ?>"
                                             class="img-fluid" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-8 d-flex align-items-center">
            ...
            <?php if ($officialsByType['cityViceMayor']) : ?>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 mt-4">
                        <div class="cookie-card view-official-btn" data-bs-toggle="modal"
                             data-bs-target="#officialModal" data-id="<?= $officialsByType['cityViceMayor']->ID ?>"
                             data-position="<?= $officialsByType['cityViceMayor']->off_position ?>">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="pic">
                                        <img src="<?= base_url('admin/image/CITYOFFICIAL/' . $officialsByType['cityViceMayor']->img_loc) ?>"
                                             class="img-fluid" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-8 d-flex align-items-center">
            ...
            <div class="row">
                <?php foreach ($officialsByType['cityCouncilors'] as $official) : ?>
                    <div class="col-lg-6 mt-4">
                        <div class="cookie-card view-official-btn" data-bs-toggle="modal"
                             data-bs-target="#officialModal" data-id="<?= $official->ID ?>"
                             data-position="<?= $official->off_position ?>">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="pic">
                                        <img src="<?= base_url('admin/image/CITYOFFICIAL/' . $official->img_loc) ?>"
                                             class="img-fluid" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-8 d-flex align-items-center">
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <?php if ($officialsByType['abcPresident']) : ?>
                        <div class="cookie-card view-official-btn" data-bs-toggle="modal"
                             data-bs-target="#officialModal" data-id="<?= $officialsByType['abcPresident']->ID ?>"
                             data-position="<?= $officialsByType['abcPresident']->off_position ?>">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="pic">
                                        <img src="<?= base_url('admin/image/CITYOFFICIAL/' . $officialsByType['abcPresident']->img_loc) ?>"
                                             class="img-fluid" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-8 d-flex align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <?php if ($officialsByType['skFederationPresident']) : ?>
                        <div class="cookie-card view-official-btn" data-bs-toggle="modal"
                             ...
                             data-id="<?= $officialsByType['skFederationPresident']->ID ?>"
                             data-position="<?= $officialsByType['skFederationPresident']->off_position ?>">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="pic">
                                        <img src="<?= base_url('admin/image/CITYOFFICIAL/' . $officialsByType['skFederationPresident']->img_loc) ?>"
                                             class="img-fluid" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-8 d-flex align-items-center">
...
<body>
<div class="modal fade" id="officialModal_1" tabindex="-1" role="dialog" aria-labelledby="officialModalLabel" aria-hidden="true">
