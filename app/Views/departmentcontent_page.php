        ...
        <div class="about-content">
          <div class="row align-items-center">
            <div class="col-md-4 text-center mb-3 mb-md-0">
              <img src="<?= base_url('admin/image/DEPT/' . $dept->img_logo) ?>" alt="Department Logo" style="max-width:120px; max-height:120px; display:inline-block; border-radius:12px; box-shadow:0 2px 8px rgba(0,0,0,0.08); margin-bottom:10px;" />
              <div class="bg-light p-3 rounded shadow-sm">
                <p class="mb-0"><strong>Department Head:</strong> <?= htmlspecialchars($dept->head) ?></p>
              </div>
            </div>
            <div class="col-md-8">
              <?= $dept->about ?>
