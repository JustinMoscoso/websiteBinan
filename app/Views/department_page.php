            ...
            <?php if (!empty($depts)): ?>
                <?php foreach ($depts as $data): ?>
                    <div class='col-lg-4 col-md-6 d-flex align-items-stretch mt-4 justify-content-center' data-aos='zoom-in' data-aos-delay='200'>
                        <!--<a href="<?php /*= base_url('/departmentcontent/' . $data->ID) */?>" class="text-decoration-none" style="width: 100%">-->
                        <a href="<?php echo base_url('/departmentcontent/' . $data->ID); ?>" class="text-decoration-none" style="width: 100%">
