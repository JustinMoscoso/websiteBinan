                                        ...
                                        <form id="addForm" class="modal-content border-0 shadow-lg"
                                            ...
                                            <div class="modal-body p-4">
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-md-6">
                                                        <label for="content_category"
                                                            class="form-label small fw-bold text-secondary">Information
                                                            Type /
                                                            Category <span class="text-danger">*</span></label>
                                                        <select class="form-select" id="content_category"
                                                            name="content_category" required>
                                                    ...
                                                    <div class="col-md-6">
                                                        <label for="myrname"
                                                            class="form-label small fw-bold text-secondary">Full Name of
                                                            Mayor <span class="text-danger">*</span></label>
                                                        <input type="text" class="form-control" id="myrname"
                                                            name="myrname" placeholder="e.g. Hon. John Doe" required>
                                                    </div>

                                                    <div class="col-12">
                                                        <label
                                                            class="form-label small fw-bold text-secondary mb-1">Personal
                                                            Data / Narrative Biography
                                                            <span class="text-danger">*</span></label>
                                                        <div class="editor-wrapper shadow-sm">
                                                            <div id="addPerdataEditor" style="height: 180px;"></div>
                                                        </div>
                                                        <input type="hidden" id="addPerdataHidden" name="perdata"
                                                            required>
                                                    </div>

                                                    <div class="col-12">
                                                        <label for="mayorimg"
                                                            class="form-label small fw-bold text-secondary">Media Assets
                                                            / Press
                                                            Gallery Files</label>
                                                        <input type="file" class="form-control" id="mayorimg"
                                                            name="mayorimg[]" accept="image/*" multiple>
                                        ...
                                        <form id="editForm" class="modal-content border-0 shadow-lg"
                                            ...
                                            <div class="modal-body p-4">
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-md-6">
                                                        <label for="edit_content_category"
                                                            class="form-label small fw-bold text-secondary">Information
                                                            Type / Category <span class="text-danger">*</span></label>
                                                        <select class="form-select" id="edit_content_category"
                                                            name="edit_content_category" required>
                                                    ...
                                                    <div class="col-md-6">
                                                        <label for="editmyrname"
                                                            class="form-label small fw-bold text-secondary">Full Name of
                                                            Mayor
                                                            <span class="text-danger">*</span></label>
                                                        <input type="text" class="form-control" id="editmyrname"
                                                            name="editmyrname"
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <input type="hidden" id="editperdataHidden" name="editperdata"
                                                            required>
                                                    </div>

                                                    <div class="col-12">
                                                        <label for="editmayorimg"
                                                            class="form-label small fw-bold text-secondary">Upload
                                                            Replacements
                                                            Media File assets</label>
                                                        <input type="file" class="form-control" id="editmayorimg"
                                                            name="editmayorimg[]" accept="image/*" multiple>
