<div class="pagetitle d-flex justify-content-between align-items-center mb-4 pb-2 border-bottom">
  ...
  <button type="button" class="btn btn-theme shadow-sm px-4 fw-semibold transition-all" data-bs-toggle="modal" data-bs-target="#addModal">
    <i class="bi bi-plus-circle me-2"></i>Add Post Content
  </button>
</div>
...
<div class="card card-premium mb-4 border-start border-4" style="border-start-color: var(--theme-mid-green) !important;">
            ...
            <div class="row g-3 align-items-end">
                <div class="col-lg-5 col-md-12">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control border-start-0" name="search" placeholder="Search Title / Author / Year...">
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-12">
                    <div class="d-flex gap-2">
                        <button type="reset" class="btn btn-outline-danger w-50 fw-semibold" style="height: 38px;">
                            Clear
                        </button>
                        <button type="submit" class="btn btn-theme w-50 fw-semibold shadow-sm" id="searchBtn" style="height: 38px;">
                            Search
                        </button>
                    </div>
                </div>
        ...
        <form id="addForm" class="modal-content border-0 shadow-lg" enctype="multipart/form-data">
            ...
            <div class="modal-body p-4">
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        <label for="content_category" class="form-label small fw-bold text-secondary">Post Classification Category <span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-4">
                        <label for="author" class="form-label small fw-bold text-secondary">Author Profile / Publisher</label>
                        <input type="text" class="form-control bg-light text-muted" id="author" name="author" value="<?= $user->fname . ' ' . $user->lname ?>" readonly>
                    </div>
                    
                    <div class="col-md-4">
                        <label for="newsImg" class="form-label small fw-bold text-secondary">Cover Banner Graphic <span class="text-danger">*</span></label>
                        <input type="file" class="form-control" id="newsImg" name="newsImg" accept="image/*" required>
                    </div>
                    
                    <div class="col-12">
                        <label for="title" class="form-label small fw-bold text-secondary">Post Headline / Article Title <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="title" name="title" placeholder="Enter headline title details..." required>
                    </div>
                    
                    <div class="col-12">
                        <label for="addDescHidden" class="form-label small fw-bold text-secondary mb-1">Body Context / Editor Copy <span class="text-danger">*</span></label>
        ...
        <form id="editForm" class="modal-content border-0 shadow-lg" enctype="multipart/form-data">
            ...
            <div class="modal-body p-4">
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        <label for="edit_content_category" class="form-label small fw-bold text-secondary">Post Classification Category <span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-4">
                        <label for="editAuthor" class="form-label small fw-bold text-secondary">Author Profile / Publisher</label>
                        <input type="text" class="form-control bg-light text-muted" id="editAuthor" name="editAuthor" value="<?= $user->fname . ' ' . $user->lname ?>" readonly>
                    </div>
                    
                    <div class="col-md-4">
                        <label for="editNewsImg" class="form-label small fw-bold text-secondary">Replace Cover Banner Graphic Asset</label>
                        <input type="file" class="form-control" id="editNewsImg" name="editNewsImg" accept="image/*">
                    </div>
                    
                    <div class="col-12">
                        <label for="editTitle" class="form-label small fw-bold text-secondary">Post Headline / Article Title <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="editTitle" name="editTitle" placeholder="Update headline title details..." required>
                    </div>
                    
                    <div class="col-12">
                        <label for="editDescHidden" class="form-label small fw-bold text-secondary mb-1">Body Context / Editor Copy <span class="text-danger">*</span></label>
                        <div class="editor-wrapper shadow-sm">
