        ...
        <form id="departmentSearchForm">
            <div class="row g-3 align-items-end">
                <div class="col-lg-7 col-md-12">
                    ...
                    <input type="text" class="form-control filter-input" id="searchDept" placeholder="Search Department / Officer...">
                </div>
...
<div class="modal fade modal-lg" id="addModal" tabindex="-1" data-bs-backdrop="static" aria-hidden="true">
      ...
      <div class="modal-body p-4">
          <div class="row g-3">
              <div class="col-md-6">
                  ...
                  <input type="text" class="form-control shadow-sm" id="txtDept" name="txtDept" placeholder="Enter department name" required>
              </div>
              <div class="col-md-6">
                  <label for="txtHead" class="form-label small fw-bold text-secondary">Officer in Charge</label>
                  <input type="text" class="form-control shadow-sm" id="txtHead" name="txtHead" placeholder="Enter full name" required>
              </div>
              ...
              <div class="col-md-6 mt-2">
                  ...
                  <input type="file" class="form-control shadow-sm" id="deptOrgChart" name="deptOrgChart" accept="image/*">
...
<div class="modal fade modal-lg" id="editModal" tabindex="-1" data-bs-backdrop="static" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">     
      ...
      <div class="modal-body p-4">
          <div class="row g-3">
              <div class="col-md-6">
                  ...
                  <input type="text" class="form-control shadow-sm" id="editDept" name="editDept" placeholder="Enter department name" required>
              </div>
              <div class="col-md-6">
                  <label for="editHead" class="form-label small fw-bold text-secondary">Officer in Charge</label>
                  <input type="text" class="form-control shadow-sm" id="editHead" name="editHead" placeholder="Enter full name" required>
              </div>
              <div class="col-12 mt-2">
              ...
              <div class="col-12 mt-2">
                  <label for="editQuillPolicy" class="form-label small fw-bold text-secondary">Quality Policy</label>
              ...
              <div class="col-md-6 mt-2">
                  ...
                  <input type="file" class="form-control shadow-sm" id="editdeptImg" name="editdeptImg" accept="image/*">
              ...
              <div class="col-md-6 mt-2">
                  ...
                  <input type="file" class="form-control shadow-sm" id="editdeptOrgChart" name="editdeptOrgChart" accept="image/*">
