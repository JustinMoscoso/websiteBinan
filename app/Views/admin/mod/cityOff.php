                        ...
                        <div class="row g-2 admin-filter-actions">
                            ...
                            <div class="col-12 col-md-4">
                                <button type="button" class="btn btn-success w-100 shadow-sm fw-semibold text-nowrap "
                                    onclick="openCityOffModal('add')" style="height: 38px;">
                                    Add Record
                                </button>
                            </div>
                        </div>
...
<div class="modal fade" id="addModal" tabindex="-1" data-bs-backdrop="static" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <form id="cityOffForm" class="modal-content border-0 shadow-lg">
            <input type="hidden" id="cityOffId" name="id">
            <input type="hidden" id="cityOffMode" name="mode" value="add">
            <input type="hidden" id="years_of_service_input" name="years_of_service">
            <input type="hidden" id="personal_data_input" name="personal_data">
            <input type="hidden" id="awards_input" name="awards">
                ...
                <div class="row g-4">
                        ...
                        <div class="card border-0 shadow-sm p-4 rounded-3 bg-white">
                            ...
                            <div class="mb-3">
                                <label for="offimg" class="form-label small fw-bold text-secondary">Primary Profile
                                    Image Badge <span id="offimgRequiredMark" class="text-danger">*</span></label>
                    ...
                    <div class="col-12 d-flex flex-column gap-3">
                        <div class="card border-0 shadow-sm p-4 bg-white">
                            ...
                            <div class="mb-3">
                                <label class="form-label small fw-bold text-secondary mb-1">Years of Service</label>
                            ...
                            <div class="mb-3">
                                <label class="form-label small fw-bold text-secondary mb-1">Personal Data</label>
                                <div class="editor-wrapper">
            ...
            <div class="modal-footer bg-light px-4 py-3 border-top">
                ...
                <button id="btnCityOffSave" type="submit" class="btn btn-success px-4">Save</button>
            </div>
        </form>
    </div>
</div>
