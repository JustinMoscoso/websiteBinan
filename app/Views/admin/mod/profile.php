...
<ul class="nav nav-tabs mb-4" id="profileTabs" role="tablist">
    <li class="nav-item" role="presentation">
        <button class="nav-link active font-weight-bold" id="edit-profile-tab" data-bs-toggle="tab" data-bs-target="#edit-profile" type="button" role="tab" aria-controls="edit-profile" aria-selected="true">
            Edit Profile
        </button>
    </li>
    <?php if (!empty($profile_department)): ?>
    <li class="nav-item" role="presentation">
        <button class="nav-link font-weight-bold" id="edit-department-tab" data-bs-toggle="tab" data-bs-target="#edit-department" type="button" role="tab" aria-controls="edit-department" aria-selected="false">
            Edit Department
        </button>
    </li>
    <?php endif; ?>
                ...
                <div class="border rounded p-4 bg-light h-100 text-center">
                    <div class="mb-3">
                        <?php if (!empty($profile_picture_url)): ?>
                            <img id="profilePicturePreview" src="<?= esc($profile_picture_url) ?>" alt="Profile picture"
                                class="rounded-circle shadow-sm" style="width: 160px; height: 160px; object-fit: cover;">
                        <?php else: ?>
                            ...
                            <img id="profilePicturePreview" src="" alt="Profile picture"
                                class="rounded-circle shadow-sm d-none" style="width: 160px; height: 160px; object-fit: cover;">
                        <?php endif; ?>
                    </div>
                    ...
                    <form id="profilePictureForm" enctype="multipart/form-data">
                        <div class="mb-3 text-left">
                            ...
                            <input type="file" class="form-control" id="profileImage" name="profileImage" accept="image/png,image/jpeg,image/webp" required>
            ...
            <div class="profile-department-card">
                <div class="profile-department-card__header">
                    <div class="profile-department-card__identity">
                        <button type="button" class="profile-department-card__logo" id="profileDeptLogoButton" title="Change department logo" aria-label="Change department logo">
                            <?php if (!empty($profile_department->img_logo)): ?>
                                <img id="profileDeptLogoCell" src="<?= site_url('admin/image/DEPT/' . $profile_department->img_logo) ?>" alt="">
                        ...
                        <div>
                            ...
                            <div class="profile-department-card__title <?= $profileDeptName === '' ? 'is-empty' : '' ?>" id="profileDeptNameCell">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li>
                                <a class="dropdown-item profile-dept-status-action" href="#" data-current-status="<?= esc($profile_department->status ?? '') ?>">
                                    <i class="fas fa-toggle-<?= ($profile_department->status ?? '') === 'ACTIVE' ? 'on' : 'off' ?> mr-1"></i>
                ...
                <div class="profile-department-card__body">
                    <div class="dept-info-area">
                        ...
                        <div class="dept-officer-value <?= $profileDeptHead === '' ? 'is-unassigned' : '' ?>" id="profileDeptHeadCell">
                            <?= esc($profileDeptHead !== '' ? $profileDeptHead : 'Unassigned') ?>
                        </div>
                        <a href="#" class="dept-assign-cta <?= $profileDeptHead !== '' ? 'd-none' : '' ?>" id="profileDeptAssignCta">
                    ...
                    <div class="dept-info-area">
                        ...
                        <div id="profileDeptStatusCell">
                            ...
                            ?>
                            <button type="button" class="dept-status-toggle profile-dept-status-action" data-current-status="<?= esc($deptStatus) ?>" aria-label="Toggle department status">
                                <span class="dept-status-switch <?= esc($deptStatusClass) ?>">
                                    ...
                                    <span class="dept-status-switch__label"><?= esc($deptStatus ? ucfirst(strtolower($deptStatus)) : 'Unknown') ?></span>
                                </span>
                            </button>
                        </div>
                    </div>
...
<?php if (!empty($profile_department)): ?>
<div class="modal fade" id="editLinkedDepartmentModal" tabindex="-1" aria-labelledby="editLinkedDepartmentModalLabel" aria-hidden="true">
            ...
            <form id="profileDepartmentForm" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div id="profileDeptAboutEditor" style="height: 120px;"><?= $profile_department->about ?? '' ?></div>
                    ...
                    <div class="mb-3">
                        ...
                        <div id="profileDeptContactEditor" style="height: 120px;"><?= $profile_department->contact ?? '' ?></div>
                    ...
                    <div class="mb-3">
                        ...
                        <div id="profileDeptMissionEditor" style="height: 120px;"><?= $profile_department->mission ?? '' ?></div>
                    ...
                    <div class="mb-3">
                        ...
                        <div id="profileDeptVisionEditor" style="height: 120px;"><?= $profile_department->vision ?? '' ?></div>
                    ...
                    <div class="mb-3">
                        ...
                        <div id="profileDeptPolicyEditor" style="height: 120px;"><?= $profile_department->quality_policy ?? '' ?></div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mt-2" id="profileDeptLogoPreview">
                            <?php if (!empty($profile_department->img_logo)): ?>
                                <img src="<?= site_url('admin/image/DEPT/' . $profile_department->img_logo) ?>" alt="Department logo"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" id="profileDeptOrgChart" name="deptOrgChart" accept="image/*">
                        <div class="mt-2" id="profileDeptOrgChartPreview">
                            <?php if (!empty($profile_department->org_chart_img)): ?>
                                <img src="<?= site_url('admin/image/DEPT/' . $profile_department->org_chart_img) ?>" alt="Organizational chart"
