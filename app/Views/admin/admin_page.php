    ...
    <div class="d-flex align-items-center justify-content-between">
        <a href="<?= base_url('admin/dashboard') ?>" class="logo d-flex align-items-center">
            ...
            <div class="d-flex flex-column align-items-start" style="margin-left: 10px;">
                ...
                <hr style="width: 100%; margin: 5px 0; border: none; border-top: 2px solid #000;">
...
<aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link <?= $mode == 'dashboard' ? '' : 'collapsed' ?>"
               href="<?= $mode == 'dashboard' ? '#' : site_url('admin/dashboard') ?>">
        ...
        <li class="nav-item">
            <a class="nav-link <?= $mode == 'postcontent' ? '' : 'collapsed' ?>"
               href="<?= $mode == 'postcontent' ? '#' : site_url('admin/postcontent') ?>">
        ...
        <li class="nav-item">
            <a class="nav-link <?= $mode == 'mayor' ? '' : 'collapsed' ?>"
               href="<?= $mode == 'mayor' ? '#' : site_url('admin/mayor') ?>">
        ...
        <li class="nav-item">
            <a class="nav-link <?= $mode == 'about' ? '' : 'collapsed' ?>"
               href="<?= $mode == 'about' ? '#' : site_url('admin/about') ?>">
        ...
        <li class="nav-item">
            <a class="nav-link <?= $mode == 'services' ? '' : 'collapsed' ?>"
               href="<?= $mode == 'services' ? '#' : site_url('admin/services') ?>">
        ...
        <li class="nav-item">
            <a class="nav-link <?= $mode == 'brgy' ? '' : 'collapsed' ?>"
               href="<?= $mode == 'brgy' ? '#' : site_url('admin/brgy') ?>">
        ...
        <li class="nav-item">
            <a class="nav-link <?= $mode == 'dept' ? '' : 'collapsed' ?>"
               href="<?= $mode == 'dept' ? '#' : site_url('admin/dept') ?>">
        ...
        <li class="nav-item">
            <a class="nav-link <?= $mode == 'cityOff' ? '' : 'collapsed' ?>"
               href="<?= $mode == 'cityOff' ? '#' : site_url('admin/cityOff') ?>">
        ...
        <li class="nav-item">
            <a class="nav-link <?= $mode == 'fullDisc' ? '' : 'collapsed' ?>"
               href="<?= $mode == 'fullDisc' ? '#' : site_url('admin/fullDisc') ?>">
        ...
        <li class="nav-item">
            <a class="nav-link <?= $mode == 'careers' ? '' : 'collapsed' ?>"
               href="<?= $mode == 'careers' ? '#' : site_url('admin/careers') ?>">
        ...
        <li class="nav-item">
            <a class="nav-link <?= $mode == 'jobs' ? '' : 'collapsed' ?>"
               href="<?= $mode == 'jobs' ? '#' : site_url('admin/jobs') ?>">
        ...
        <li class="nav-item">
            <a class="nav-link <?= $mode == 'invest' ? '' : 'collapsed' ?>"
               href="<?= $mode == 'invest' ? '#' : site_url('admin/invest') ?>">
        ...
        <li class="nav-item">
            <a class="nav-link <?= $mode == 'contacts' ? '' : 'collapsed' ?>"
               href="<?= $mode == 'contacts' ? '#' : site_url('admin/contacts') ?>">
                <i class="bi bi-telephone"></i>
                <span>Contacts</span>
            </a>
        </li><!-- End COntacts Nav -->

        <?php if ($user->user_lvl == 'SUPERADMIN' || $user->user_lvl == 'DEVELOPER') { ?>
        <li class="nav-heading">Admin</li>

        <li class="nav-item">
            <a class="nav-link <?= $mode == 'accounts_mgmt' ? '' : 'collapsed' ?>"
               href="<?= $mode == 'accounts_mgmt' ? '#' : site_url('admin/accounts_mgmt') ?>">
                <i class="bi bi-person-gear"></i>
                <span>Account Management</span>
            </a>
        </li><!-- End Profile Page Nav -->
            <li class="nav-item">
                <a class="nav-link <?= $mode == 'admin' ? '' : 'collapsed' ?>"
                   href="<?= $mode == 'audit' ? '#' : site_url('admin/audit') ?>">
