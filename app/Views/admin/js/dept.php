<script>
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.status === 1) {
                    ...
                    //$('#editDept')[0].selectize.setValue(res.dept_name); // Set the value for selectize
    ...
    // Deactivate function
    function deactivate(deptId) {
        Swal.fire({
            heightAuto: false,
            title: 'Deactivate Department Content',
    ...
    // Activate function
    function activate(deptId) {
        Swal.fire({
            heightAuto: false,
            title: 'Activate Department Content',
