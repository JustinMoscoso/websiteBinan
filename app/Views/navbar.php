...
<!-- NavBar Start -->
<nav class="stroke navbar navbar-expand-lg navbar-light fixed-top"
  ...
  <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
    ...
    <a class="navbar-brand d-flex align-items-center" href="<?= base_url('/home') ?>">
      ...
      <div class="d-none d-sm-flex flex-column align-items-start ms-2">
        <span style="font-size: 12px; font-family: 'Gill Sans'; font-weight: 900; color: #000;">REPUBLIC OF THE
          PHILIPPINES</span>
        <hr style="width: 100%; margin: 1px 0; border: none; border-top: 2px solid #000;">
        <!-- Adjust the margin and border-top color as needed -->
        <span style="font-size: 14px; font-family: 'Gill Sans'; font-weight: 900; color: #000;">CITY GOVERNMENT OF
          BIÑAN</span>
      </div>
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto">
        <li class="nav-item">
          <a class="navi nav-link fw-bold <?= ($currentpage == 'home') ? 'active' : ''; ?>"
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="transDropdown">
            ...
            <li><a class="dropdown-item" href="https://www.facebook.com/CIOBinan/posts/767111615440109/">City
                Ordinances</a></li>
        ...
        <li class="nav-item"><a class="navi nav-link fw-bold <?= ($currentpage == 'services') ? 'active' : ''; ?>"
            href="<?= base_url('/services') ?>">eSERVICES</a></li>
        <li class="nav-item"><a class="navi nav-link fw-bold <?= ($currentpage == 'careers') ? 'active' : ''; ?>"
            href="<?= base_url('/careers') ?>">CAREERS</a></li>
        <li class="nav-item"><a class="navi nav-link fw-bold" href="<?= base_url('/jobs') ?>">JOBS</a></li>
        <li class="nav-item"><a class="navi nav-link fw-bold <?= ($currentpage == 'invest') ? 'active' : ''; ?>"
            href="<?= base_url('/invest') ?>">INVEST</a></li>
        <li class="nav-item"><a class="navi nav-link fw-bold <?= ($currentpage == 'contact') ? 'active' : ''; ?>"
