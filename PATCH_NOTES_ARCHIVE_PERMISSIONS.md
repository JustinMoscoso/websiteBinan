...
- Department-scoped `ADMIN` accounts are now restricted to only their assigned Content Management modules; unassigned modules are hidden from the sidebar and blocked by direct URL access.
